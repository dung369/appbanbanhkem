...
export const CHATBOT_DATA: CategoryData[] = [
  {
    ...
    keywords: [
      ...
      "mẫu bánh cưới",
      "giá bánh cưới",
      "bánh cưới sang trọng",
    ],
    faqs: [
      {
        question: "Shop có bánh cưới không?",
        answer:
          "Dạ có ạ! Shop chúng em chuyên làm bánh cưới nhiều tầng, từ 2-5 tầng, đẹp sang trọng ạ. Anh/chị cần tư vấn thêm không ạ?",
      },
      {
        question: "Bánh cưới có mấy tầng?",
        answer:
          "Shop có bánh cưới từ 2-5 tầng ạ. Tùy vào số lượng khách và không gian tiệc mà anh/chị có thể chọn số tầng phù hợp nhé!",
      },
      {
        question: "Giá bánh cưới bao nhiêu?",
        answer:
          "Giá bánh cưới dao động từ 2-10 triệu tùy size và tầng ạ:\n• 2 tầng: 2-3 triệu\n• 3 tầng: 3-5 triệu\n• 4-5 tầng: 5-10 triệu\nCó thể tùy chỉnh theo yêu cầu!",
      },
      {
        question: "Có làm bánh cưới theo mẫu không?",
        answer:
          "Dạ có ạ! Anh/chị có thể gửi hình mẫu cho em, shop sẽ tư vấn và báo giá cụ thể. Hoặc có thể tham khảo bộ sưu tập bánh cưới của shop nhé!",
      },
      {
        question: "Bánh cưới cần đặt trước bao lâu?",
        answer:
          "Bánh cưới nên đặt trước 1-2 tuần để shop chuẩn bị kỹ lưỡng nhất ạ. Trường hợp gấp, anh/chị liên hệ shop để được tư vấn nhé!",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Shop có nhiều size bánh sinh nhật ạ:\n• Size mini (4-6 người): 200-300k\n• Size 20cm (8-10 người): 350-450k\n• Size 25cm (12-15 người): 500-650k\n• Size 30cm (20-25 người): 700k-1tr",
      },
      {
        question: "Có viết chữ lên bánh không?",
        answer:
          "Dạ có ạ! Shop viết chữ lên bánh miễn phí. Anh/chị cho em biết nội dung cần viết là gì nhé!",
      },
      {
        question: "Có giao trong ngày không?",
        answer:
          "Dạ có ạ! Nếu đặt trước 3 tiếng, shop có thể giao trong ngày. Đặt gấp liên hệ hotline để được hỗ trợ nhanh nhất nhé!",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Dạ có ạ! Shop nhận làm bánh cho:\n• Sự kiện công ty\n• Khai trương\n• Hội nghị\n• Tiệc buffet\nCó thể in logo, thiết kế theo yêu cầu!",
      },
      {
        question: "Có in logo lên bánh không?",
        answer:
          "Dạ có ạ! Shop in logo bằng giấy ăn được hoặc vẽ tay rất đẹp. Anh/chị gửi file logo cho em nhé!",
      },
      {
        question: "Bánh sự kiện đặt số lượng lớn được không?",
        answer:
          "Dạ được ạ! Shop nhận đơn từ 20-100+ phần bánh. Đặt số lượng lớn sẽ có giá ưu đãi nhé!",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Dạ có ạ! Mua kèm đồ ăn vặt khi đặt bánh sẽ được giảm 10-20% nhé!",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Hiện tại bánh hot nhất shop:\n• Bánh bơ sữa Hàn Quốc\n• Bánh tiramisu hộp\n• Bánh gấu 3D\n• Bánh kem phô mai\nĐều có sẵn, đặt là có luôn ạ!",
      },
      {
        question: "Có bánh hot trên TikTok không?",
        answer:
          "Dạ có ạ! Shop luôn cập nhật các mẫu bánh trend trên TikTok. Anh/chị muốn mẫu nào, gửi link em xem nhé!",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "Dạ có ạ! Anh/chị đang chat với bộ phận CSKH rồi ạ. Em sẵn sàng tư vấn cho anh/chị!",
      },
      {
        question: "Bao lâu thì nhân viên trả lời?",
        answer:
          "Shop trả lời trong vòng 1-5 phút trong giờ hành chính ạ. Ngoài giờ sẽ phản hồi sớm nhất có thể!",
      },
    ],
  },
  {
    category: "phu-kien",
    keywords: ["phụ kiện bánh", "nến sinh nhật", "dao cắt bánh", "topper bánh"],
    faqs: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Dạ có ạ! Shop có dịch vụ gói quà đẹp với giá từ 20-50k tùy loại hộp. Có kèm thiệp chúc miễn phí!",
      },
      {
        question: "Có giao bánh làm quà không?",
        answer:
          "Dạ có ạ! Shop giao tận nơi, có thể ghi địa chỉ người nhận và lời nhắn nhủ. Rất tiện để tặng quà bất ngờ!",
      },
    ],
  },
  {
    category: "thiep-dien-tu",
    keywords: ["thiệp điện tử", "e-card", "lời chúc sinh nhật", "thiệp online"],
    faqs: [
      {
        question: "Có thiệp điện tử không?",
        answer:
          "Dạ có ạ! Shop có thiệp điện tử miễn phí khi đặt bánh. Anh/chị muốn nội dung gì em thiết kế giúp nhé!",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Dạ có ạ! Shop nhận tùy chỉnh:\n• Màu sắc\n• Chữ viết\n• Hình ảnh in\n• Trang trí theo chủ đề\nAnh/chị có ý tưởng gì không ạ?",
      },
      {
        question: "Có làm bánh theo ảnh mẫu không?",
        answer:
          "Dạ có ạ! Anh/chị gửi hình mẫu cho em, shop sẽ tư vấn độ khả thi và báo giá cụ thể nhé!",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        question: "Cảm ơn",
        answer:
          "Dạ không có gì ạ! Shop luôn sẵn sàng phục vụ. Chúc anh/chị một ngày tốt lành! 🎂💕",
      },
    ],
  },
];
